...
export default function Layout({props}){
    ...
    const contents = [
        [<Icon icon="iwwa:dashboard" width={30} height={30}  style={{color: 'black'}} />,'Dashboard',0],
        [<Icon icon="streamline:user-profile-focus" width={30} height={30}  style={{color: 'black'}} />,'Profile',1],
        [<Icon icon="fluent:notepad-person-24-regular" width={30} height={30}  style={{color: 'black'}} />,'My Resume',2],
