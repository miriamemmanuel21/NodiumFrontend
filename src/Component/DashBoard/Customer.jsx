...
//   const services = ['Consulting', 'Web Development', 'Marketing', 'Design', 'Customer Support'];  
...
//   const handleGoClick = () => {  
//     if (selectedService) {  
//       // Navigate to the service dashboard based on selected service  
//       navigate(`/service/${selectedService}`);  
//     }  
//   };  
  
//   const handleProviderInfo = ()=> {
//     if(providerInfo){
//         navigate(`/webdeveloper${setProviderInfo}`)
//     }
//   }
//   return (  
